...
// From wind direction in degrees, determine compass direction as a string (e.g NW)
    ...
    /**
     * Helper method to provide the icon resource id according to the com.tandon.aishwary.weather condition id returned
    ...
    /**
     * Helper method to return whether or not Weather is using local graphics.
     *
     * @param context Context to use for retrieving the preference
     * @return true if Weather is using local graphics, false otherwise.
     */
    public static boolean usingLocalGraphics(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        String weatherArtPack = context.getString(R.string.pref_art_pack_sunshine);
        return prefs.getString(context.getString(R.string.pref_art_pack_key),
                weatherArtPack).equals(weatherArtPack);
    }
    ...
    public static String getArtUrlForWeatherCondition(Context context, int weatherId) {
        ...
        // Based on com.tandon.aishwary.weather code data found at:
    ...
    /**
     * Helper method to provide the art resource id according to the com.tandon.aishwary.weather condition id returned
     * by the OpenWeatherMap call.
     * @param weatherId from OpenWeatherMap API response
     * @return resource id for the corresponding icon. -1 if no relation is found.
     */
    public static int getArtResourceForWeatherCondition(int weatherId) {
        // Based onweather code data found at:
        // http://bugs.openweathermap.org/projects/api/wiki/Weather_Condition_Codes
        if (weatherId >= 200 && weatherId <= 232) {
    ...
    /**
     * Helper method to provide the string according to the com.tandon.aishwary.weather
     * condition id returned by the OpenWeatherMap call.
     * @param context Android context
     * @param weatherId from OpenWeatherMap API response
     * @return string for theweather condition. null if no relation is found.
     */
