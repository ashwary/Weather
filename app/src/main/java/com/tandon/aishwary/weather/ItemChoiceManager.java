...
/**
 * Created by Aishwary on 9/15/2015.
 */
public class ItemChoiceManager {
    ...
    public ItemChoiceManager(ForecastAdapter adapter) {
        mAdapter = adapter;
    }
    ...
    public void onClick(ForecastAdapter.ForecastAdapterViewHolder vh) {
    ...
    public void onBindViewHolder(ForecastAdapter.ForecastAdapterViewHolder vh, int position) {
