...
public class DetailActivity extends ActionBarActivity {
    ...
    public static class DetailFragment extends Fragment implements LoaderCallbacks<Cursor> {
        ...
        public static final String FORECAST_SHARE_HASHTAG = " #WeatherApp";
        ...
        public Loader<Cursor> onCreateLoader(int id, Bundle args) {
            ...
            // Now we create and return a CursorLoader that will take care
        ...
        public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
            ...
            //if onCreateOptionMenu has already happened, we need to update the share intent now
